 ...
 */
$config['site_title']                 = "RMS";       // Site Title, example.com
$config['admin_email']                = "contact@hankrestaurant.com"; // Admin Email, admin@example.com
...
$config['user_expire']                = 1500;               // How long to remember the user (seconds). Set to zero for no expiration
